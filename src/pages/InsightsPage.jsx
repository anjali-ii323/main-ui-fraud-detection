  ...
  return (
    <div className="space-y-8 pb-8">
      <SectionHeader
        ...
        title="Agent improves decision-making over time using reward feedback"
        description="The reinforcement loop drives measurable improvement in reward, consistency, and intervention quality across episodes."
      />
          ...
          <div className="mt-4 h-80">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={rewardCurve}>
                ...
                <Line type="monotone" dataKey="baseline" name="Before" stroke="#f59e0b" strokeWidth={2} />
                <Line type="monotone" dataKey="improved" name="After" stroke="#38bdf8" strokeWidth={3} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </motion.section>
            ...
            <div className="mt-4 h-40">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={rewardCurve}>
                  ...
                  <YAxis stroke="#94a3b8" />
                  <Tooltip contentStyle={{ background: '#111827', border: '1px solid rgba(255,255,255,0.1)' }} />
                  <Area type="monotone" dataKey="successRate" stroke="#38bdf8" fill="url(#cyan)" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </div>
